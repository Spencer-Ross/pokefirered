const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_LINK_CABLE, SPECIES_PORYGON2}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL_ATK_GT_DEF, 20, SPECIES_HUNTAIL},
                            {EVO_LEVEL_ATK_LT_DEF, 20, SPECIES_GOREBYSS}},
